...
The game has collision physics and saves your score and level to a file so that you can continue later. Your score increases by collecting coins and powerups. 
The game will also have a 90 second timer for each level, if the timer runs out the game is over. 
I decided to make this as a backup option after my two other ideas (Legend of Zelda clone and updated 3D horror game) turned out to be unfeasible due to the short development time.
